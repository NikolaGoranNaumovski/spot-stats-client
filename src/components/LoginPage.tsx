        ...
        >
          <Stack spacing={4} alignItems="center">
            ...
            <Typography variant="body1" color="text.secondary" sx={{ maxWidth: 400 }}>
              Connect your Spotify account to view detailed analytics about your most listened tracks
              across hourly, daily, monthly, and yearly timeframes.
            </Typography>
            ...
            {/* Footer Note */}
            <Typography variant="caption" color="text.secondary" sx={{ mt: 2, fontSize: '0.75rem' }}>
              Note: This is a demo application. Spotify credentials are placeholder values.
              <br />
